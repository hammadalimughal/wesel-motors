...
router.post('/create', async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`/demo-custom/car-project/admin/category-list`)
    } catch (error) {
        console.error('Error creating category:', error)
        return res.redirect(`/demo-custom/car-project/admin/new-category?error=${error.message}`)
    }
})
...
router.post('/edit', async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`/demo-custom/car-project/admin/edit-category?id=${id}&error=${error.message}`)
    }
})
...
router.post('/delete', async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`/demo-custom/car-project/admin/category-list?error=${error.message}`)
    }
})
