    ...
    initFormChoices() {
        ...
        choicesExamples.forEach(function (item) {
            ...
            if (isChoicesVal["data-choices-groups"]) {
                choiceData.placeholderValue = "Select an option";
            }
            ...
            const choices = new Choices(item, choiceData);
             if (isChoicesVal["data-initial-multiple-value"]) {
                try {
                    const value = JSON.parse(isChoicesVal["data-initial-multiple-value"].value);
                    choices.setValue(value);
                } catch (error) {
                    console.error("Invalid JSON string in data-initial-multiple-value attribute:", error);
                }
            }
            if (isChoicesVal["data-choices-text-disabled-true"]) {
                choices.disable();
